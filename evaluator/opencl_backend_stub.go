...
func newOpenCLMLPBackend(_ *MLP) (*openclMLPBackend, error) {
	return nil, fmt.Errorf("OpenCL backend is required; rebuild with '-tags opencl' and install OpenCL SDK/runtime headers")
}
